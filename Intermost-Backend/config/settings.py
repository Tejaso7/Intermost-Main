...
FILE_UPLOAD_MAX_MEMORY_SIZE = 524288000  # 500MB max file memory size
...
if AWS_ACCESS_KEY_ID and AWS_STORAGE_BUCKET_NAME:
    STORAGES = {
        'default': {
            'BACKEND': 'apps.core.storage.PublicMediaS3Storage',
        },
        'staticfiles': {
            'BACKEND': 'django.contrib.staticfiles.storage.StaticFilesStorage',
        }
    }
    DEFAULT_FILE_STORAGE = 'apps.core.storage.PublicMediaS3Storage'
    AWS_S3_CUSTOM_DOMAIN = f'{AWS_STORAGE_BUCKET_NAME}.s3.amazonaws.com'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/'
elif env('CLOUDINARY_CLOUD_NAME', default=''):
    STORAGES = {
        'default': {
...
REST_FRAMEWORK = {
    ...
    ],  # Removed BrowsableAPIRenderer for security
}
